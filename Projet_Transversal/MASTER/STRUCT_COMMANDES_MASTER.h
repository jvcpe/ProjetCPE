...
enum Arret_Urgence{Oui,Non};
 
struct COMMANDES       // Cette structure contient toutes les commandes envoyées par la centrale de commande
...
{           
   ...
   int  DCT_Obst_Resolution;      // Paramètre résolution angulaire de la détection d'obstacle
...
struct INFORMATIONS       // Cette structure contient toutes les informations susceptibles d'être transmises à la centrale de commande
